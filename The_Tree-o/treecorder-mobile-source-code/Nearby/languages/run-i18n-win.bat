...
lupdate "%WORKDIR%" -extensions qml %WORKDIR%\%LANGUAGES_FOLDER%\i18n\appinfo.tri %WORKDIR%\%LANGUAGES_FOLDER%\i18n\appschema.tri -ts %WORKDIR%\%LANGUAGES_FOLDER%\%APP_NAME%.ts
