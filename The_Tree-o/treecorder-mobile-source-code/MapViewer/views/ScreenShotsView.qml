...
Popup {
        ...
        contentItem:Rectangle{
            ...
            states: [
                ...
                /* State {
                    ...
                    PropertyChanges {
                        target: viewerPanel
                        width:screenshotsPage.width - 0.25 * app.width
            ...
            Rectangle{
                ...
                SketchPanel{
                    ...
                    anchors.bottomMargin:0 //app.isIphoneX?app.units(20) * scaleFactor:0
    ...
    function updateScreenShotsModel (updateCurrentIndex,action) {
        ...
        {
            var screenshotsBasePath = app.screenshotsCache.storagePath + portalItem.id + "/"
            //var screenshotsBasePath ="~/ArcGIS/AppStudio/cache/"+ app.info.itemId.toString() + "/screenshotsCache/" + portalItem.id + "/"
            app.screenShotsCacheFolder = AppFramework.fileInfo(screenshotsBasePath).folder
            app.screenShotsCacheFolder.makeFolder()
        }
        ...
        for (var i=0; i<allScreenShots.length; i++) {
            if (allScreenShots[i]) {
                ...
                var _modDate = new Date(_modifiedDate).toLocaleDateString(Qt.locale(), Locale.ShortFormat)
