        ...
        content: Pane {
            ...
            RowLayout {
                ...
                Item {
                    ...
                    Layout.preferredWidth: parseInt(thumbnail.aspectRatio * Layout.preferredHeight)
                    Layout.margins: 0
                    ...
                    RowLayout{
                        ...
                        Controls.BaseText {
                            text: {
                                let txt = ""
                                if (type === "maparea")
                                    txt = new Date(modifiedDate).toLocaleDateString(Qt.locale(), Locale.ShortFormat)
                                else
                                    txt = new Date(modified).toLocaleDateString(Qt.locale(), Locale.ShortFormat)
...
//                                        var _size = fileFolder.fileInfo("%1.mmpk".arg(id)).size
                                        var _size = size
                                        txt = _size > -1 ? " %1MB".arg((_size/1000000).toFixed(1)) : ""
                                    }
                                }
    ...
    PortalItem {
        ...
        Component.onCompleted: {
            if(delegateType ===  "Mobile Map Package")
