...
ListView {
    ...
    delegate: Pane {
                        ...
                        MouseArea {
                            ...
                            onClicked: {
                                ...
                                else
                                {
                                    ...
                                    downloadObj["thumbnailImg"] = thumbnailUrl
        ...
        Controls.PopupMenu {
            ...
            onMenuItemSelected: {
                ...
                case qsTr("Open"):
                    mapPage.willReadAppJson = false

                    // To enable filters to be read and populated again (if not done so, especially in offline mode)
     ...
     function processMapAreaParameters(result)
    {
        ...
        offlineMapJob.resultChanged.connect(() => {
                                                ...
                                                if(offlineMapJob.result){
                                                    ...
                                                    {
                                                        let mapareadownloaded = mapAreas[downloadIndx]
    ...
    function saveMapInfo (downloadedmapareaId,mapareadownloaded) {
        ...
        showDownloadCompletedMessage(qsTr("Download Complete."),mapareadownloaded.title)
