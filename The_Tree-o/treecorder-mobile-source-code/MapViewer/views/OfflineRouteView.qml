...
FocusScope {
    ...
    property bool screenWidth:app.isLarge
        ...
        Connections {
            ...
            onSolveRouteStatusChanged: {
                ...
                if (currentRouteTask.solveRouteStatus === Enums.TaskStatusErrored)
                    console.error(currentRouteTask.error.message);
                        ...
                        Item {
                            ...
                            ColumnLayout{
                                ...
                                Controls.CustomTextField {
                                    ...
                                    Connections {
                                        target: fromTextField.properties
...
//                                                    mapView.allPoints.pop()
            ...
            RouteDirectionView {
                ...
                visible: isShowDirection && app.isLarge
            ...
            Rectangle {
                ...
                color: "transparent"
                visible:!app.isLarge && directionView.errorView
